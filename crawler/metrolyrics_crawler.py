...
from crawler.base_crawler import CrawlerType2
...
def main():
    # Dictionary of number of pages for artists per initial
    # Original values are mentioned in corresponding comments
    pages_dict = {
        '1': 8,  # 8
        'a': 85,  # 85
        'b': 81,  # 81
